      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-xl border-b border-slate-200/50 shadow-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-blue-500/30">I</div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <div className="mt-20 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
            ...
            <div className="flex justify-center items-center -space-x-3">
              <img className="w-14 h-14 rounded-full border-4 border-white object-cover shadow-lg hover:scale-110 transition-transform cursor-pointer" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80" alt="User" />
              <img className="w-14 h-14 rounded-full border-4 border-white object-cover shadow-lg hover:scale-110 transition-transform cursor-pointer" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&q=80" alt="User" />
              <img className="w-14 h-14 rounded-full border-4 border-white object-cover shadow-lg hover:scale-110 transition-transform cursor-pointer" src="https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=100&q=80" alt="User" />
