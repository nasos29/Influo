...
DROP POLICY IF EXISTS "Service role can insert analytics" ON influencer_analytics;
DROP POLICY IF EXISTS "Service role can select analytics" ON influencer_analytics;
